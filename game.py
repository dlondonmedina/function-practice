# Create a function called game. It should take one argument, which is the number
# the number the user is trying to guess. 
# The function should prompt a user to guess a number repeatedly until they guess the correct number.
# If the user's guess is too high, the program should print "Too High!"
